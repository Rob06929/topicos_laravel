$(document).ready(function(){
    ...
    async function face(){
        ...
        //const labels = ['ross', 'rachel', 'chandler', 'monica', 'phoebe', 'joey','keanu','evo']
        //label.push(nombre_usuario);

        //const labeledFaceDescriptors = await Promise.all(
            //labels.map(async label => {

                const imgUrl = `images/${nombre_usuario}.jpg`
                ...
                return new faceapi.LabeledFaceDescriptors(nombre_usuario, faceDescriptors)
            //})
        //);
