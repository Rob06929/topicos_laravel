...
<body class="">
    <div id="app">
        ...
        <nav class="fixed h-20 top-0 z-50 w-full dark:bg-gray-800 dark:border-gray-700 ">
            <div class="bg-green-800 h-full px-3 pb-3 lg:px-5 lg:pl-3 shadow-lg"
                style="border-bottom-right-radius: 3rem; border-bottom-left-radius: 3rem;">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">

                        <a href="#" class="flex ml-2 md:mr-24">
                            <img src="../img/escudo2.png" width="200" height="300"
                                alt="escudo de santa cruz de la sierra">
                        </a>
                    </div>
                    <div class="flex items-center mr-4">
                        <div>
                            <a type="button" href="{{ route('logout') }}"
                                class="flex text-sm justify-center items-center" aria-expanded="false">
                                ...
                                <svg class="w-10 h-10 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path stroke="currentColor" stroke-linecap="round" width="100" height="90"
        ...
        <aside id="logo-sidebar"
            class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 mt-4 transition-transform -translate-x-full bg-white translate-x-0"
            aria-label="Sidebar">
            <div class="h-full py-3 pr-4 overflow-y-auto bg-green-700"
                ...
                <ul class="pl-4 space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('lista_denuncias') }}"
                            class="flex items-center p-2 hover:text-gray-900 rounded-lg hover:bg-green-100 text-gray-100 group">
                            <span class="ml-3">Denuncias</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('lista_areas') }}"
                            class="flex items-center p-2 hover:text-gray-900 rounded-lg hover:bg-green-100 text-gray-100 group">
                            <span class="ml-3">Areas</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('list_complaints') }}"
                            class="flex items-center p-2 hover:text-gray-900 rounded-lg hover:bg-green-100 text-gray-100 group">
